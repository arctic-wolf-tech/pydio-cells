...
const (
	MetadataExif              = "videoExif"
	MetadataCompatOrientation = "video_exif_orientation"
)

var (
	exifTaskName = "actions.videos.exif"
)
...
func (e *ExifProcessor) GetDescription(lang ...string) actions.ActionDescription {
	return actions.ActionDescription{
		...
		Label:             "Extract EXIF",
		Icon:              "video",
		Description:       "Extract EXIF data from jpeg videos and store them as indexed metadata",
		SummaryTemplate:   "",
		HasForm:           false,
